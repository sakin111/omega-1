    ...
    <div className="navbar  bg-white border-none px-10 mx-auto ">
      <div className="navbar-start">
        ...
        <div className="flex justify-center items-center gap-7 ">
          <img src="https://i.ibb.co/CJZD7gt/af7855a6-032e-401c-a201-142ba199f02d.jpg" alt="logo" className="w-12 h-12 rounded-full" />
      ...
      <div className="navbar-end">
          ...
          <div>
            <button size="medium" className=" btn m-1 text-white bg-gradient-to-br from-teal-400 to-cyan-500 hover:bg-gradient-to-bl font-medium rounded-lg px-4 py-2.5 font-mono"
